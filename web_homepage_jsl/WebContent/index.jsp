...
<html lang="ko">
 <head>
  ...
  <!-- 다른 폴더의 파일을 가져다 쓰기 위해선 link 라는 태그에 href 라는 속성을 붙여서 사용한다. -->
  ...
  <!-- 공통으로 쓰는건 script 뒤에 src 속성으로 js 파일로된 자바 스크립트 들을 가져다 쓸 수 있다. -->
 ...
 -->
	...
	<div class="top_navigation">
		...
		<header class="header">
			...
			<nav class="top_right">
				...
				<li class="first">
					<%if(sessionName.equals("")){%>
						...
						<a href="/web_homepage_jsl/member/member_join.jsp">회원가입</a>
					<%}else{ %>
						<p style="display:inline"><%=sessionName %>님 로그인</p></li><li>
			...
			<div class="gnb_group">
				<a href=""><h1 class="logo"><img src="images/jsl_logo_f.png"><h1></a>
				<nav class="gnb">
					<ul class="nav_1depth">
						...
						<li><a href="portfolio.jsp">포트폴리오</a>
							<ul class="nav_2depth">
						...
						<li><a href="/web_homepage_jsl/notice/notice_list_new.jsp">커뮤니티</a>
							<ul class="nav_2depth">
