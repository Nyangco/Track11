...
<% 
	...
	FaqDto dto = dao.updateViewDB(no);
%>
	<!-- sub contents -->
	<div class="sub_title">
		<h2>자주하는 질문(FAQ)</h2>
	  ...
	  <form name="faq">
			<table class="bord_table">
				...
				<tbody>
					<tr>
						<th>제목</th>
						<td><input type="text" name="t_title" value="<%=dto.getTitle()%>">
						<input type="hidden" name="t_no" value="<%=dto.getNo() %>"></td>
					</tr>
					<tr>
						<th>내용</th>
						<td>
					...
					<tr>
						<th>최종 수정일</th>
						<td><%
							if(dto.getUp_date()==null) out.print("수정 이력 없음");
							else out.print(dto.getUp_date());
						%></td>
					</tr>
				</tbody>
			</table>
