...
public class NoticeDto {
	...
	public NoticeDto(String no, String title, String reg_date, String reg_name, int hit) {
		super();
		this.no = no;
		this.title = title;
	...
	public NoticeDto(String title, String content, String attach, String reg_date, String reg_name, int hit) {
		super();
		this.title = title;
		this.content = content;
		this.attach = attach;
