...
public class MemberDto {
	...
	private String hobby_reading, hobby_sports, reg_date, update_date, last_login_date, exit_date, email;
	...
	//세션 만들기 용
	public MemberDto(String sLevel, String name, String exit_date, String last_login_date) {
		super();
		this.sLevel = sLevel;
		this.name = name;
		this.exit_date = exit_date;
